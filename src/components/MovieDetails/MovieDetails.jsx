...
function MovieDetails(props) {
  return (
    ...
    // <div className={props.selectedMedia?'modal-bg':""}>
      <div className="movie_card" id="container" style={{display: props.selectedMedia.id?"block":"none"}}>
        ...
        <div className="info_section">
          ...
          <div className="movie_social">
            <ul>
              <li><button onClick={()=>{props.addMovie(props.selectedMedia)}}><i className="fa-solid fa-bookmark"></i>&nbsp; Add to watch list</button></li>
